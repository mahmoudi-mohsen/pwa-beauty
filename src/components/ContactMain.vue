<template>
  <div class="contact">
    <ul class="social z-3">
      <li><a href="tel:+989037249424">موبایل <i class="fas fa-mobile"></i></a></li>
      <li><a href="https://www.instagram.com/gisoo_seifi">اینستاگرام <i class="fab fa-instagram"></i></a></li>
      <li><a href="mailto:gisooseifi1372@gmail.com">ایمیل <i class="fa fa-envelope"></i></a></li>
    </ul>
    <section class="bg-dark-dark">
      <div class="spotlight overflow-hidden bg-cover bg-size&#45;&#45;cover"
           data-spotlight="fullscreen"
           data-separator="rounded-right" data-separator-orientation="bottom">
        <span class="mask bg-gradient-dark opacity-7"></span>
        <div class="spotlight-holder">
          <div class="container py-8 d-flex align-items-center">
            <div class="col pt-6 pt-lg-0">
              <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                  <KinesisContainer animationDuration="1000" easing="cubic-bezier(0.23, 1, 0.32, 1)">
                    <KinesisElement :src="require(`@/assets/images/gs-logo-s.png`)" :strength="20" type="depth"
                                    tag="img"/>
                  </KinesisContainer>
                  <h6 class="text-uppercase text-white ls-2 mb-5">برای گرفتن مشاوره با من در تماس باشید</h6>
                  <KinesisContainer animationDuration="1000" easing="cubic-bezier(0.23, 1, 0.32, 1)"
                                    class="button-container">
                    <KinesisElement :strength="-10" type="depth" tag="a" href="tel:+989037249424"
                                    class="glass-btn blue-btn p-2">
                      <img :src="require(`@/assets/images/about/mobile.png`)" alt="mobile"
                           style="width: 5.5em;height: 100%;object-fit: contain;">
                    </KinesisElement>
                    <KinesisElement tag="a" :strength="10" type="depth" href="https://www.instagram.com/gisoo_seifi"
                                    class="glass-btn amber-btn p-4">
                      <img :src="require(`@/assets/images/about/instagram.webp`)" alt="instagram" style="width: 6em;">
                    </KinesisElement>
                    <KinesisElement :strength="-10" type="depth" href="mailto:gisooseifi1372@gmail.com"
                                    class="glass-btn  red-btn p-2">
                      <img :src="require(`@/assets/images/about/gmail.png`)" alt="gmail" style="width: 6em;">
                    </KinesisElement>
                  </KinesisContainer>
                </div>
              </div>
...
.social li {
  ...
  margin: 5px;
  background: rgba(182, 180, 180, 0.36);
  width: 300px;
  text-align: left;
  padding: 10px;
  transition: all 1s;
...
.spotlight {
  position: relative;
  background-image: url("@/assets/images/about/contact.webp");
...
.bg-gradient-dark {
  background: linear-gradient(50deg, #2a3036 0, #12131f 100%) !important;
}
...
.glass-btn {
  ...
  &.blue-btn {
    -webkit-box-shadow: 0 20px 20px -17px rgba(0, 111, 255, 0.53);
    -moz-box-shadow: 0 20px 20px -17px rgba(0, 111, 255, 0.53);
    box-shadow: 0 20px 20px -17px rgba(0, 111, 255, 0.53);

    &:hover {
      -webkit-box-shadow: 0 20px 35px -16px rgba(0, 111, 255, 0.65);
      -moz-box-shadow: 0 20px 35px -16px rgba(0, 111, 255, 0.65);
      box-shadow: 0 20px 35px -16px rgba(0, 111, 255, 0.65);
    }

  }

  &.red-btn {
    -webkit-box-shadow: 0 20px 20px -17px rgba(255, 16, 39, 0.5);
    -moz-box-shadow: 0 20px 20px -17px rgba(255, 16, 39, 0.5);
    box-shadow: 0 20px 20px -17px rgba(255, 16, 39, 0.5);

    &:hover {
      -webkit-box-shadow: 0 20px 35px -16px rgba(255, 16, 39, 0.57);
      -moz-box-shadow: 0 20px 35px -16px rgba(255, 16, 39, 0.57);
      box-shadow: 0 20px 35px -16px rgba(255, 16, 39, 0.57);
    }

  }

  &.amber-btn {
    -webkit-box-shadow: 0 20px 20px -17px rgba(124, 16, 255, 0.53);
    -moz-box-shadow: 0 20px 20px -17px rgba(124, 16, 255, 0.53);
    box-shadow: 0 20px 20px -17px rgba(124, 16, 255, 0.53);

    &:hover {
      -webkit-box-shadow: 0 20px 35px -16px rgba(124, 16, 255, 0.68);
      -moz-box-shadow: 0 20px 35px -16px rgba(124, 16, 255, 0.68);
      box-shadow: 0 20px 35px -16px rgba(124, 16, 255, 0.68);
    }

  }

  &:hover {
    background-color: darken(#4a5261, 2%);
